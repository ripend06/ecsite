...
public interface UserRepository extends JpaRepository<User,Long>{     //<userテーブルの Entity, UserテーブルのIDの型である「Long」>
	
	List<User> findByUserNameAndPassword(String uesrName, String password);     //findByUserNameAndPasswor?
